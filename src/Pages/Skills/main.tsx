    ...
    return (
        ...
        <div className="skills">
            ...
            <div className="skillsList">
                ...
                <div>
                    Operating System Familiarity: Comfortable with both Windows and Linux (both graphical and just terminal), showing an ability to adapt to new technical environments.
                </div>
                <div className="divider"></div>
                <div>
